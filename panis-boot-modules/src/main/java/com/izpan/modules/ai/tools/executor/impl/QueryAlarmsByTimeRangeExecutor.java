...
public class QueryAlarmsByTimeRangeExecutor implements IAiToolExecutor {
    ...
    public String getToolName() {
        return "query_alarms_by_time_range";
    }
    ...
    public AiToolResult execute(Map<String, Object> arguments) {
        ...
        try {
            ...
            queryWrapper.between(DeviceAlarm::getAlarmTime, startDateTime, endDateTime)
            ...
            log.error("查询时间范围报警失败", e);
            return AiToolResult.failure(getToolName(), "查询时间范围报警失败: " + e.getMessage());
        }
    }
