...
public interface IAuthenticationFacade {
     ...
     * 邮箱验证码登录
     *
     * @param emailCodeLoginDTO 邮箱验证码登录对象
     * @return {@link Map<String, String>} 包含token等信息的map
     * @author payne.zhuang
     * @CreateTime 2026-01-25
     */
     ...
     * 邮箱注册
     *
     * @param emailRegisterDTO 邮箱注册对象
     * @return {@link Boolean} 是否注册成功
     * @author payne.zhuang
     * @CreateTime 2026-01-26
     */
    Boolean emailRegister(EmailRegisterDTO emailRegisterDTO);
}
