...
public interface ISysUserService extends IService<SysUser> {
     ...
     *
     * @param user 用户对象
     * @param needCheck 是否需要检查用户信息
     * @author payne.zhuang
     * @CreateTime 2026-01-25
     */
    void saveUserToSession(SysUser user, boolean needCheck);
     ...
     * @CreateTime 2026-01-25
     */
    boolean saveLoginLog(MonLogsLogin loginLog);

    /**
     * 获取登录日志服务
     *
     * @return {@link IMonLogsLoginService} 登录日志服务
     * @author payne.zhuang
     * @CreateTime 2026-01-25
     */
    IMonLogsLoginService getMonLogsLoginService();
}
